...
/*
$statement=$pdo->prepare("Select DISTINCT genericarticlesgroups.designation as designation,ambrand.brandId as  logo ,ambrand.brandName as name  ,articles.articleNumber  as number
From articles
INNER JOIN ambrand
...
where genericarticlesgroups.lang='$lang' and genericarticlesgroups.designation LIKE '%$code%' and articlesvehicletrees.linkingTargetId=$carid and articlesvehicletrees.linkingTargetType='P' order by genericarticlesgroups.designation,ambrand.brandName
");
*/
